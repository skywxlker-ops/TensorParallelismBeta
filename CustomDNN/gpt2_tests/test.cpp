...
int main() {
    try {
        ...
        const int global_batch = 10000;  // Global batch size
        ...
        // Create data loaders
        std::string data_root = "/home/blu-bridge005/Desktop/Anuj@BluBridge/TensorParallel/CustomDNN/shard";
        ...
        if (rank == 0) {
            log_file.open("Naive/naive_run_log_1shard.csv");
