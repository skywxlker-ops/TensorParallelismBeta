...
namespace OwnTensor
{
    ...
    std::vector<size_t> CachingCUDAAllocator::get_stats_vector(int device) const {
        ...
        stats_vector.push_back(stats.num_allocs);
        stats_vector.push_back(stats.num_frees);
        stats_vector.push_back(stats.num_ooms);
        stats_vector.push_back(stats.num_alloc_retries);
        stats_vector.push_back(stats.active_peak);
        stats_vector.push_back(stats.active_current);
        stats_vector.push_back(stats.allocated_peak);
        stats_vector.push_back(stats.allocated_current);
