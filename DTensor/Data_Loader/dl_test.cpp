...
//         b.input = OwnTensor::Tensor (OwnTensor::Shape{{B_,T_}}, {OwnTensor::Dtype::UInt16, OwnTensor::DeviceIndex(OwnTensor::Device::CUDA, cur_dev)});
//         b.input.set_data(b.x);

//         b.target = OwnTensor::Tensor (OwnTensor::Shape{{B_,T_}}, {OwnTensor::Dtype::UInt16, OwnTensor::DeviceIndex(OwnTensor::Device::CUDA, cur_dev)});
