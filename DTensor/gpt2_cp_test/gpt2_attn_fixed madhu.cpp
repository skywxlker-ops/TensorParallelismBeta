...
int main() {
    try {
        ...
        // Create data loaders
        std::string data_root = "/home/blubridge-036/Documents/edu_data";
        ...
        // Create CSV log file
        std::ofstream log_file("gpt2_attn_fixed.csv");
        ...
        for (int step = start_step; step < MAX_STEPS; ++step) {
            ...
            // CudaTimer timer_optim;

            // timer_optim.start_timer();
            optimizer.step();
            // double time_optim = timer_optim.get_elapsed_seconds();
