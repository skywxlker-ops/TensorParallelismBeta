...
public: 
    ...
    result_t all_reduce(const void* sendbuff, void* recvbuff,size_t count, OwnTensor::Dtype dtype, op_t operation);
    
    result_t reduce_scatter(const void* sendbuff, void* recvbuff, size_t recv_count, OwnTensor::Dtype dtype, op_t operation);
    
    result_t all_gather(const void* sendbuff, void* recvbuff, size_t sendcount, OwnTensor::Dtype dtype);
    
    result_t gather(const void* sendbuff, void* recvbuff, size_t count, OwnTensor::Dtype dtype, int root);
    
    result_t reduce(const void* sendbuff, void* recvbuff, size_t count, OwnTensor::Dtype dtype, op_t op, int root);
    
    result_t scatter(const void* sendbuff, void* recvbuff, size_t count, OwnTensor::Dtype dtype, int root);
    
    result_t broadcast(const void* sendbuff, void* recvbuff, size_t count, OwnTensor::Dtype dtype, int root);
    
    result_t alltoall(const void* sendbuff, void* recvbuff, size_t count, OwnTensor::Dtype dtype);
    
    result_t send(const void* sendbuff, size_t count, OwnTensor::Dtype dtype, int recv_rank);
    
    result_t recieve(void* recvbuff, size_t count, OwnTensor::Dtype dtype, int send_rank); 

    result_t sendrecv(const void* sendbuff, void* recvbuff, int send_rank, int recv_rank, size_t count, OwnTensor::Dtype dtype);
    //nvshmem
