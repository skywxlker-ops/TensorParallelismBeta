...
public:
    ...
    Batch next_batch() {
        ...
        b.input = OwnTensor::Tensor (OwnTensor::Shape{{B_,T_}}, OwnTensor::TensorOptions().with_dtype(OwnTensor::Dtype::UInt16).with_device(dev));
        b.input.set_data(b.x);

        b.target = OwnTensor::Tensor (OwnTensor::Shape{{B_,T_}}, OwnTensor::TensorOptions().with_dtype(OwnTensor::Dtype::UInt16).with_device(dev));
